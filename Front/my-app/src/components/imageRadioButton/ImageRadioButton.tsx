  ...
  return (
    <div className="image-radio-buttons">
      {images.map((image, index) => (
        <label key={index} className="image-radio-button">
          <input
            type="radio"
            name={name}
            value={image.value}
         ...
         {showAlert && (
        <Alert
          message="¡Oops! No puedes cambiar el tipo de camiseta una vez un diseño ha sido aplicado."
          type="info"
          onClose={closeAlert}
        />
      )}
